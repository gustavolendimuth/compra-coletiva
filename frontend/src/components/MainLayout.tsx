  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="container-custom py-3 md:py-4">
          <div className="flex items-center justify-between h-10 md:h-12">
            ...
            <div className="hidden md:flex items-center gap-4 h-full">
              <Link
                href="/campanhas"
                className={`px-4 py-2 rounded-lg transition-colors font-semibold text-base ${
      ...
      <button
        ...
        className={`fixed right-4 md:bottom-6 md:right-6 z-[60] bg-primary-600 text-white p-3 md:p-4 rounded-full shadow-lg hover:bg-primary-700 transition-all hover:scale-110 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${
