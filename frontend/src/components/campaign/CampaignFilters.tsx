...
export type CampaignStatusFilter = 'ACTIVE' | 'CLOSED' | 'SENT' | 'ARCHIVED' | undefined;
export type CampaignQuickFilter = 'all' | 'mine' | 'fromSellers' | 'similarProducts';
    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-12 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent text-base shadow-sm transition-shadow hover:shadow-md"
        />
        {search && (
          <button
            type="button"
