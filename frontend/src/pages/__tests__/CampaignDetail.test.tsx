...
describe('CampaignDetail', () => {
  ...
  const mockProducts = [
    createMockFullProduct({ id: 'product-1', name: 'Product 1', price: 50, weight: 100 }),
    createMockFullProduct({ id: 'product-2', name: 'Product 2', price: 75, weight: 200 }),
    createMockFullProduct({ id: 'product-3', name: 'Product 3', price: 100, weight: 300 }),
  ];
