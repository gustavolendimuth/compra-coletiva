...
import { createMockProduct, createMockOrder, createMockAnalytics } from '@/__tests__/mock-data';
...
describe('OverviewTab', () => {
  const mockProducts = [
    createMockProduct({ id: 'product-1', name: 'Product A', price: 50 }),
    createMockProduct({ id: 'product-2', name: 'Product B', price: 75 }),
    createMockProduct({ id: 'product-3', name: 'Product C', price: 100 }),
  ];
  ...
  describe('Rendering', () => {
    ...
    it('should render add product button for campaign editors', () => {
      render(<OverviewTab {...defaultProps} isActive={true} canEditCampaign={true} />);
    ...
    it('should not render add product button for non-editors', () => {
      render(<OverviewTab {...defaultProps} isActive={true} canEditCampaign={false} />);
  ...
  describe('Products Section', () => {
    ...
    it('should not render products section when there are no products', () => {
      ...
      expect(screen.queryByText('Produtos Disponíveis')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Questions and Answers Section', () => {
    ...
    it('should pass campaignId to CampaignChat', () => {
      ...
      expect(screen.getByText('Campaign Chat: test-campaign-123')).toBeInTheDocument();
    });
  ...
  describe('Action Callbacks', () => {
    ...
    it('should call onAddOrder when add order button is clicked', async () => {
      ...
      const addOrderButton = screen.getByRole('button', { name: /adicionar pedido/i });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle empty orders list', () => {
      ...
      render(<OverviewTab {...defaultProps} orders={[]} analytics={emptyAnalytics} />);
